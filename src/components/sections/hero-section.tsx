...
export function HeroSection() {
  ...
  const marqueeSlides: MarqueeSlide[] = [
    ...
    {
      text: 'TRANSFORMASI BISNIS JE-P3 MENUJU BISNIS FUTURISTIK',
    },
  ]
    ...
    <section className="relative min-h-[70vh] flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-emerald-50 via-white to-amber-50 dark:from-emerald-950 dark:via-gray-900 dark:to-amber-950 animate-gradient-flow">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden -z-10">
          <div className="absolute top-20 left-10 w-64 h-64 bg-emerald-400/20 rounded-full blur-3xl floating-orb" />
          <div
            className="absolute top-40 right-20 w-80 h-80 bg-amber-400/20 rounded-full blur-3xl floating-orb"
            style={{ animationDelay: '2s' }}
          />
          <div
            className="absolute bottom-20 left-1/3 w-72 h-72 bg-emerald-400/15 rounded-full blur-3xl floating-orb"
            style={{ animationDelay: '4s' }}
          />
          <div
            className="absolute bottom-40 right-1/3 w-96 h-96 bg-amber-400/15 rounded-full blur-3xl floating-orb"
          ...
          <div className="max-w-6xl mx-auto text-center space-y-8">
            ...
            <div className="inline-flex items-center gap-2 md:gap-4 px-4 md:px-6 py-3 md:py-4 bg-white dark:bg-gray-800 rounded-2xl border-2 border-green-600 dark:border-green-400 shadow-xl transition-all duration-700 animate-pop-in">
              ...
              <span className="text-lg md:text-xl lg:text-2xl font-extrabold text-green-800 dark:text-green-300 tracking-tight">
                ...
                {showCursor && typingStarted && (
                  <span className="inline-block w-1 h-5 md:h-6 lg:h-7 bg-green-600 dark:bg-green-400 ml-1 animate-pulse" />
                )}
              </span>
            </div>
            ...
            <div className="space-y-6 animate-fade-in-up">
              ...
              <p
                ...
                "
              >
                Desa Digital <span className="text-amber-600 dark:text-amber-400">→ Go Global</span>
              </p>
            </div>

            {/* Vision Statement – tanpa section-fade */}
            <div className="animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              <Card className="max-w-4xl mx-auto border-2 border-emerald-200 dark:border-emerald-800 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm card-3d-tilt card-hover-lift card-glow-hover cursor-pointer">
                <CardContent className="p-6 md:p-8">
                  <p className="text-base md:text-lg text-gray-700 dark:text-gray-300 leading-relaxed text-justify">
                    ...
                    <span className="font-semibold text-gradient-animate bg-gradient-to-r from-emerald-600 via-amber-600 to-emerald-600 bg-clip-text text-transparent">
                      Super-Ekosistem Pengusaha Multinasional Terbesar di Dunia
                    </span>{' '}
            ...
            {/* stats */}
            <div
              className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mt-8 animate-fade-in-up"
            ...
            {/* portal links */}
            <div
              className="mt-8 p-6 bg-gradient-to-r from-emerald-100 to-amber-100 dark:from-emerald-950/50 dark:to-amber-950/50 rounded-2xl border border-emerald-200 dark:border-emerald-800 transition-all duration-1000 card-glow-hover animate-fade-in-up"
              style={{ animationDelay: '0.4s' }}
            >
              <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-4">Platform JE-P3:</p>
              <div className="flex flex-wrap gap-3 justify-center stagger-children">
                {[
                  ...
                  <Button
                    ...
                    } transition-all hover:scale-105 btn-bounce glow-pulse-hover magnetic-btn`}
                    onClick={() => {
