...
export function ImpactSection() {
  const impacts = [
    ...
    },
    {
      ...
      subtext: 'Diciptakan melalui ekosistem JE-P3.',
  ...
  const farmerImpact = [
    {
      metric: 'Pendapatan Rata-rata',
      baseline: 'Rp12M',
      target: 'Rp75M',
      growth: '+525%',
    },
    {
      metric: 'Top 20% Performers',
      baseline: 'Rp25M',
      target: 'Rp200M',
      growth: '+700%',
    },
    {
      metric: 'Share Harga Jual',
      baseline: '20%',
      target: '60–70%',
      growth: '+200–250%',
    },
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900 relative overflow-hidden">
      {/* Background grid ditaruh di belakang */}
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="text-center space-y-4 animate-fade-in-up">
            ...
            >
              Investasi total Rp42,5 triliun (2026–2030) dengan proyeksi dampak transformatif bagi
              ekonomi desa Indonesia.
            </p>
          </div>

          {/* Kartu dampak utama */}
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 stagger-children animate-fade-in-up">
                ...
                >
                  <CardContent className="p-6 space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge
                        variant="outline"
                        className="text-[11px] md:text-xs hover:bg-emerald-50 dark:hover:bg-emerald-950/30 hover:border-emerald-400 dark:hover:border-emerald-600 transition-all cursor-default animate-pop-in"
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span
                          className={`font-semibold ${impact.color} animate-pulse-glow`}
              ...
              <CardContent className="p-8 md:p-12">
                <div className="space-y-6">
                  <div className="text-center space-y-2">
                    ...
                    <h3 className="text-xl md:text-2xl font-bold text-gradient-animate bg-gradient-to-r from-amber-600 to-emerald-600 bg-clip-text text-transparent animate-fade-in-up">
                        ...
                        {farmerImpact.map((item, index) => (
                          ...
                          >
                            ...
                            <td className="text-center py-4 px-4">
                              <span
                                className="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 animate-pop-in hover:bg-emerald-200 dark:hover:bg-emerald-900/50 transition-colors cursor-default"
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            <Card className="border-2 border-emerald-200 dark:border-emerald-800 card-3d-tilt card-hover-lift card-glow-hover cursor-pointer animate-shimmer">
              <CardContent className="p-8 md:p-12">
                <div className="space-y-6">
                  <div className="text-center space-y-2">
                    <div className="flex justify-center">
                      ...
                      >
                        <div className="space-y-3">
                          <div className="flex items-center justify-between">
                            <Badge
                              variant="outline"
                              className="text-xs hover:bg-emerald-50 dark:hover:bg-emerald-950/30 transition-colors"
                            >
                              {item.period}
                            </Badge>
                            <span className="text-xl md:text-2xl font-bold text-gradient-animate text-emerald-600 dark:text-emerald-400">
                              {item.amount}
                            </span>
                          </div>
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
            <Card className="border-2 border-violet-200 dark:border-violet-800 bg-gradient-to-br from-violet-50 to-pink-50 dark:from-violet-950/30 dark:to-pink-950/30 card-3d-tilt card-hover-lift card-glow-hover cursor-pointer animate-shimmer">
              <CardContent className="p-8 md:p-12">
                <div className="text-center space-y-6">
                  <h3 className="text-xl md:text-2xl font-bold text-gradient-animate bg-gradient-to-r from-violet-600 to-pink-600 bg-clip-text text-transparent animate-fade-in-up">
                    Sumber Pendanaan
                  </h3>
                  <div className="grid md:grid-cols-4 gap-4 stagger-children">
                    {[
                      ...
                      <div key={index} className="space-y-2">
                        <div className="flex justify-between text-sm">
                          <span className="font-medium text-gray-900 dark:text-gray-100 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                            {item.source}
                          </span>
                          <span
                            className="font-bold text-gray-900 dark:text-gray-100 animate-pulse-glow"
                            style={{
                        ...
                        <div className="h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                          <div
                            className={`h-full ${item.color} ${item.hover} ease-out rounded-full animate-pop-in`}
                            style={{
