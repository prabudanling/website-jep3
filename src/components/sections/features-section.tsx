  ...
  const features = [
    {
      ...
      description:
        'Platform B2B & B2C trading dengan smart contract, escrow blockchain, dan verifikasi kualitas AI.',
      benefits: [
    ...
    },
    {
      ...
      description:
        'Fintech layer lengkap dengan e-wallet, microloans, crop insurance, dan savings.',
      benefits: [
    ...
    },
    {
      ...
      description:
        'Dashboard monitoring IoT real-time untuk weather, soil, dan production data per desa.',
      benefits: [
    ...
    },
    {
      ...
      description:
        'Real-time shipment tracking dengan cold chain monitoring dan ETA prediction.',
      benefits: [
    ...
    },
    {
      ...
      description:
        'Transparency layer untuk setiap transaksi yang bisa diverifikasi publik.',
      benefits: [
    ...
    },
    {
      ...
      title: 'Member Hub',
      description:
        'Platform networking, forum komunitas, event calendar, dan peer mentoring.',
      benefits: [
    ...
    },
    {
      ...
      title: 'AI Advisor',
      description:
        'Sistem rekomendasi AI untuk komoditas, pricing, dan demand forecasting.',
      benefits: [
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="text-center space-y-4 animate-fade-in-up">
            ...
            >
              Seluruh infrastruktur digital yang dibutuhkan pengusaha desa untuk
              bertransformasi menjadi eksportir global — dari marketplace, fintech, akademi,
              hingga logistics dan AI advisor dalam satu ekosistem terpadu.
            </p>
          </div>

          {/* Grid fitur utama */}
          <div
            className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 stagger-children animate-fade-in-up"
            style={{ animationDelay: '0.2s' }}
          >
                ...
                >
                  <CardHeader className="space-y-4">
                    <div className="flex items-start justify-between">
                      ...
                      >
                        <div
                          className={`p-3 rounded-xl ${feature.color} group-hover:scale-110 transition-transform icon-hover-lift icon-hover-glow`}
                        >
                    ...
                    <div className="space-y-2">
                      {feature.benefits.map((benefit, bIndex) => (
                        <div key={bIndex} className="flex items-start gap-2 group/benefit">
                          <AnimatedIcon animation="pop-in" delay={bIndex * 60} duration={0.6}>
                            <CheckCircle2 className="w-4 h-4 text-emerald-500 flex-shrink-0 mt-0.5 icon-hover-glow" />
                          </AnimatedIcon>
                          <span className="text-xs md:text-sm text-gray-700 dark:text-gray-300 group-hover/benefit:text-emerald-600 dark:group-hover/benefit:text-emerald-400 transition-colors">
                            {benefit}
                          </span>
                        </div>
                      ))}
              ...
              <CardContent className="p-8 md:p-12">
                <div className="text-center space-y-6">
                  <h3 className="text-xl md:text-2xl font-bold text-gradient-animate bg-gradient-to-r from-emerald-600 to-amber-600 bg-clip-text text-transparent animate-fade-in-up">
                    Platform Tambahan untuk Stakeholder Kunci
                  </h3>
                  <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 stagger-children">
                    {[
                      {
                        name: 'Investor Portal',
                        description: 'Impact dashboard, financial reports, dan deal flow terkurasi.',
                        icon: LineChart,
                        color: 'bg-emerald-100 dark:bg-emerald-900/50',
                      },
                      {
                        name: 'Government Interface',
                        description: 'KPI desa, tracking dana desa, dan compliance reporting.',
                        icon: Shield,
                        color: 'bg-amber-100 dark:bg-amber-900/50',
                      },
                      {
                        name: 'Export Desk',
                        description: 'Dokumentasi ekspor, trade finance, dan buyer matching global.',
                        icon: Globe,
                        color: 'bg-blue-100 dark:bg-blue-900/50',
                      },
                      {
                        name: 'Cooperative Hub',
                        description: 'Aggregasi volume, sertifikasi, dan manajemen koperasi.',
                        icon: Users,
