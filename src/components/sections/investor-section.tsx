...
export function InvestorSection() {
  ...
  const documents = [
    { name: 'Whitepaper JE-P3 7.0', type: 'PDF', size: '2,5 MB', date: '8 Feb 2026' },
    { name: 'Financial Projection 2026–2030', type: 'PDF', size: '1,8 MB', date: '1 Feb 2026' },
    { name: 'Investor Presentation Q1 2026', type: 'PPTX', size: '5,2 MB', date: '15 Jan 2026' },
    { name: 'ESG Impact Report', type: 'PDF', size: '3,1 MB', date: '1 Jan 2026' },
  ]
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="text-center space-y-4 animate-fade-in-up">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gradient-animate bg-gradient-to-r from-amber-600 via-emerald-600 to-amber-600 bg-clip-text text-transparent animate-text-reveal">
              Investor Portal
            </h2>
            <p
            ...
            >
              Peluang investasi di super-ekosistem yang mengubah lanskap ekonomi desa Indonesia.
            </p>
          </div>

          {/* KPI utama */}
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 stagger-children animate-fade-in-up">
            {kpis.map((kpi, index) => {
              const Icon = kpi.icon
              return (
                <Card
                  key={index}
                  className="border-2 hover:shadow-2xl transition-all hover:-translate-y-1 card-3d-tilt card-hover-lift card-glow-hover cursor-pointer scroll-fade-in visible"
                ...
                >
                  <CardContent className="p-6 space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">{kpi.metric}</p>
                    </div>
                    <Badge
                      variant="outline"
          ...
          <Card className="border-2 border-emerald-200 dark:border-emerald-800 bg-gradient-to-br from-emerald-50 to-amber-50 dark:from-emerald-950/30 dark:to-amber-950/30 card-3d-tilt card-hover-lift card-glow-hover animate-fade-in-up">
            <CardHeader>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                    ...
                    <li>• Network effects yang menguat seiring adopsi.</li>
                  </ul>
                </div>
                <div className="space-y-4">
                  <h4 className="font-semibold text-gray-900 dark:text-gray-100 flex items-center gap-2">
          ...
          <div className="grid md:grid-cols-2 gap-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            {/* Dokumen investor */}
            <Card className="border-2 border-gray-200 dark:border-gray-800 card-3d-tilt card-hover-lift">
              <CardHeader>
            ...
            {/* CTA hubungi IR */}
            <Card className="border-2 border-amber-200 dark:border-amber-800 bg-gradient-to-br from-amber-50 to-emerald-50 dark:from-amber-950/30 dark:to-emerald-950/30 card-3d-tilt card-hover-lift card-glow-hover">
              <CardHeader>
              ...
              <CardContent className="space-y-6">
                <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                  Kami menyambut pertanyaan dari investor yang ingin berpartisipasi dalam
                  transformasi ekonomi desa Indonesia melalui JE-P3.
                </p>

                <div className="space-y-3">
                  <Button className="w-full bg-emerald-600 hover:bg-emerald-700 text-white btn-bounce btn-glow magnetic-btn ripple-btn">
                    Request Investor Deck
                    <ArrowRight className="ml-2 w-4 h-4" />
                  </Button>
                  <Button
                    variant="outline"
                    className="w-full border-2 border-amber-500 text-amber-600 hover:bg-amber-50 dark:border-amber-400 dark:text-amber-400 dark:hover:bg-amber-950/30 btn-bounce magnetic-btn"
                  >
                    Jadwalkan Meeting
          ...
          {/* Struktur pendanaan */}
          <Card className="border-2 border-violet-200 dark:border-violet-800 card-3d-tilt card-hover-lift animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            <CardContent className="p-8">
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto text-sm md:text-base">
                  JE-P3 dibangun melalui sinergi pemerintah, lembaga pembangunan, sektor swasta, dan
                  koperasi untuk mencapai visi transformasi 83.763 desa.
                </p>
